...
mod tests {
    ...
    fn validate_for_none_returns_first_valid_uri() {
        let validate_against = vec!["https://harbr.dev/a"];
    ...
    fn validate_for_valid_uri_returns_first_matching_uri_ignoring_query_params()
    {
        let validate_against = vec![
            "https://harbr.dev/a?q3=p3&q4=p4",
            "https://harbr.dev/a/b/c?q1=p1&q2=p2",
        ];
        let to_validate =
            "https://harbr.dev/a/b/c?query0=param0&query1=param1"
                .to_string();
    ...
    fn validate_for_invalid_uri_returns_err() {
        let validate_against = vec!["https://harbr.dev/a"];
        let to_validate = "https://harbr.dev/a/b".to_string();
